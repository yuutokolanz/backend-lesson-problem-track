...
class RouteTest extends TestCase
{
    ...
    public function test_match_should_true_id_method_and_uri_with_params_match(): void
    {
    ...
    public function test_match_should_true_and_add_params_id_method_and_uri_with_params_match(): void
    {
        $route = new Route(method: 'GET', uri: '/test/{id}', controllerName: 'MockController', actionName: 'show');
